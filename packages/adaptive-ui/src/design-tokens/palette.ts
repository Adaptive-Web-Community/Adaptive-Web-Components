...
export const neutralBaseSwatch = createNonCss<Swatch>("neutral-base-swatch").withDefault(
    (resolve: DesignTokenResolver) => SwatchRGB.from(parseColorHexRGB(resolve(neutralBaseColor))!)
);

/** @public */
export const neutralPalette = createNonCss<Palette>("neutral-palette").withDefault((resolve: DesignTokenResolver) =>
...
/** @public */
export const accentBaseSwatch = createNonCss<Swatch>("accent-base-swatch").withDefault((resolve: DesignTokenResolver) =>
    SwatchRGB.from(parseColorHexRGB(resolve(accentBaseColor))!)
);

/** @public */
export const accentPalette = createNonCss<Palette>("accent-palette").withDefault((resolve: DesignTokenResolver) =>
